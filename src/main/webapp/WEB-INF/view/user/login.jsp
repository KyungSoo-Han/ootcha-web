...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index.jsp"><b>WMS </b>ASELCNI</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                        <button type="button" onclick="Search()" class="btn btn-primary btn-block">로그인</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
...
<script type="text/javascript" src="/mst/user/login.js?vs=<%=nowDatetime%>"></script>
</body>
</html>