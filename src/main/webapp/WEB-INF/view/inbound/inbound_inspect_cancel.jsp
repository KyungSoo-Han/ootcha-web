...
<head>
    ...
    <script type="text/javascript" src="/inbound/inbound_inspect_cancel.js?vs=<%=nowDatetime%>"></script>
...
<body>
    ...
    <button id="InspectCancel" onclick="InspectCancel()">취소</button>
    <div>
        <table>
            <tr>
    ...
    <br>
    <div id="inboundInspectCancel"  style ="width: 100%; height:400px"></div>
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function () {
        ...
        createGrid("inboundInspectCancel")
