...
<head>
    ...
    <script type="text/javascript" src="/inbound/inbound_cancel.js?vs=<%=nowDatetime%>"></script>
...
<body>
    ...
    <br>
    <div id="inboundCancel1"  style ="width: 100%; height:260px"></div>
    <div id="inboundCancel2"  style ="width: 100%; height:400px"></div>
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function () {
        ...
        createGrid("inboundCancel1")
        createGrid2("inboundCancel2")
