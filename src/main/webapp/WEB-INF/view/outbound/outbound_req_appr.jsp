...
<head>
    ...
    <script type="text/javascript" src="/outbound/outbound_req_appr.js?vs=<%=nowDatetime%>"></script>
...
<body>
    ...
    <br>
    <div id="outboundReqappr"  style ="width: 100%; height:400px"></div>
    <div id="outboundReqappr2"  style ="width: 100%; height:400px"></div>
    <div id="modalWrap" >
        <div id="modalBody" >
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function () {
        ...
        createGrid("outboundReqappr")
        createGrid2("outboundReqappr2")
