...
<body>
    ...
    <div id="locationList" style="width: 100%; height:650px"></div>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            createGrid("locationList")

        });
    </script>
<script type="text/javascript" src="/mst/location/location.js?vs=<%=nowDatetime%>"></script>
</html>
