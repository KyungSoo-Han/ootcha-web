...
let inboundPileupColumn =[
    ...
    function createGrid(container) {
        ...
        dataProvider.setFields(inboundPileupField);
        ...
        gridView.setColumns(inboundPileupColumn);
