...
let outboundReq2Column =[
    ...
    function createGrid2(container) {
        ...
        dataProvider2.setFields(outboundReq2Field);
        ...
        gridView2.setColumns(outboundReq2Column);
...
function excelExport() {
    ...
    gridView.exportGrid({
        type: "excel",
        target: "local",
        fileName: "출고요청현황" + +"_"+tempTime +".xlsx",
...
function Appr(){
    ...
    if(saveData.length > 0) {
        for (let i in saveData) {
            ...
            jsonData.outboundReqNo = document.getElementById('outboundReqNo').value;
    ...
    $.ajax({
        method : "POST",
        url : sessionStorage.getItem("serverUrl")+"/api/outboundReq/appr",
        contentType: 'application/json',
