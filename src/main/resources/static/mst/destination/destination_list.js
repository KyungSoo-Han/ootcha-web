...
function createGrid(container) {
    ...
    dataProvider.setFields(destinationListField);
    ...
    gridView.setColumns(destinationListColumn)
...
function Search(){
    ...
    let customer = document.getElementById('customerCd').value;
        ...
        $.ajax({
            method: "GET",
            url: sessionStorage.getItem("serverUrl")+"/api/destination/list?"+"bizCd="+bizCd+"&customerCd="+customer+"",
            contentType: 'application/json',
            success: function(data) {
                if (data != null) {
